...
def load_mosaic(self, index):
    ...
    labels4, segments4 = [], []
    s = self.img_size
    yc, xc = [int(random.uniform(0.97 * s, 1.03 * s)) for x in self.mosaic_border]  # mosaic center x, y
...
class Albumentations:
    ...
    def __init__(self):
        ...
        self.transform = A.Compose([
            A.Cutout(num_holes=30, max_h_size=16, max_w_size=16, fill_value=0, p=1.0),
            A.ShiftScaleRotate(shift_limit=0, scale_limit=0.1, rotate_limit=1, interpolation=1, border_mode=0),
